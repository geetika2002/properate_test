<template>
    ...
    <div class="container mt-20 my-0 xs:px-0 mx-auto bg-slate-100">
      ...
      <!-- Section:  vision -->
      <section class="ml-4 md:ml-20 mr-20 mb-16 text-gray-800 text-left">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-6 xl:gap-x-12">
          <div class="mb-12">
            <div class="flex">
              <div class="shrink-0 mt-1">
                <svg height="30" width="30">
                  <rect
                    width="30"
                    height="30"
                    style="fill: #dddddd; stroke: black; stroke-width: 3"
                  />
                </svg>
              </div>
              <div class="grow ml-4">
      ...
      <section class="md:ml-20 md:mr-20 mb-2 md:mb-16 text-gray-800 text-center">
        ...
        <div class="px-2 grid grid-cols-2 md:grid-cols-4 gap-x-6 lg:gap-x-12">
            ...
            <div class="bg-white block rounded-lg shadow-lg">
              <div class="relative overflow-hidden bg-no-repeat bg-cover">
                ...
                >
                  <path
                    fill="#fff"
                    d="M0,288L48,272C96,400,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
                  ></path>
                </svg>
              </div>
              <div class="p-6">
