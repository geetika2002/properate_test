...
<div class="container">
    ...
    <div class ="tab">
        ...
        <div class="content">
            ...
            Cras convallis nunc vitae porttitor euismod. 
             Mauris tincidunt eu enim ac pellentesque. Morbi gravida 
            enim quis fermentum bibendum. Quisque eget erat 
            at turpis condimentum pharetra. Sed consequat 
            luctus leo sed elementum.</p>
        </div>
    </div> 
...
.container .tab:nth-child(3) label h2{
    background: linear-gradient(135deg, #3c6ce7, #00eaff);
}
